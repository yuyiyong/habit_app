/*
 * @LastEditors:  
 * @LastEditTime: 2021-07-07 18:04:20
...
List<Habit> habits = Consts.habitList;
              ...
              child: CustomScrollView(
                ...
                slivers: [
                  SliverAppBar(
                    ...
                    /* new Image.network(
                      'https://s3.ifanr.com/wp-content/uploads/2019/08/Gundam-00-mobile-suit-gundam-00-20740668-1680-1050.jpg',
                      fit: BoxFit.cover,
                    ),
                    new Image.network(
                      'https://www.google.com/url?sa=i&url=https%3A%2F%2Fj.17qq.com%2Farticle%2Fsqsceqcqx.html&psig=AOvVaw0ebbMajK6wV47-fuHaSf9O&ust=1616221756536000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCKiw3brdu-8CFQAAAAAdAAAAABAI',
                      fit: BoxFit.cover,
                    ),
                    new Image.network(
                      'https://s3.ifanr.com/wp-content/uploads/2019/08/Gundam-00-mobile-suit-gundam-00-20740668-1680-1050.jpg',
  ...
  Future<Null> _handleRefresh() async {
    ...
    await Future.delayed(Duration(seconds: 2), () {
      setState(() {
        // 在列表开头添加几条数据
        List<Habit> _refreshData = List.generate(25, (i) => new Habit(Colors.yellow, '下拉刷新数据${i + 1}', "http://nimg.ws.126.net/?url=http%3A%2F%2Fdingyue.ws.126.net%2F2021%2F0609%2Fa4d4e136j00que6ox001bc000hs00loc.jpg&thumbnail=650x2147483647&quality=80&type=jpg", 4));
        // _list.insertAll(0, _refreshData);
        // _list = _refreshData;
        habits = Consts.habitList;
      });
    });
  }
